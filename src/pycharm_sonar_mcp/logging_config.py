...
_ENV_LOG_LEVEL: Final[str] = "PYCHARM_SONAR_MCP_LOG_LEVEL"
_DEFAULT_LEVEL: Final[str] = "INFO"
_VALID_LEVELS: Final[frozenset[str]] = frozenset({"DEBUG", "INFO", "WARNING", "ERROR"})
_CONFIGURED: bool = False

_LOGGER_NAME: Final[str] = "pycharm_sonar_mcp"


def _resolve_level() -> int:
    """根据环境变量解析日志级别整数,非法值回退到 INFO"""
    raw = os.environ.get(_ENV_LOG_LEVEL, _DEFAULT_LEVEL).strip().upper()
